...
public class ArbolGUI {
    ...
    private JComboBox cbHijo2;
    private JComboBox cbHijo3;
        ...
        btnAgregarNodo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    boolean esHijo2 = Boolean.parseBoolean(cbHijo2.getSelectedItem().toString());
                    boolean esHijo3 = Boolean.parseBoolean(cbHijo3.getSelectedItem().toString());
                    ...
                    arbol.anadirNodo(nuevoNodo, nodoPadre, esIzquierda,esHijo2,esHijo3);
                    imprimirArbol();
                    dibujarArbolEnPanel();
