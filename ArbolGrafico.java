    ...
    public void dibujarArbol(Graphics2D g2d, Nodo nodo, int x, int y, int dimensionX, int dimensionY) {
        if (nodo != null) {
            ...
            if (nodo.hijo2 != null) {
                ...
                dibujarArbol(g2d, nodo.hijo2, x - dimensionX / 2, y + dimensionY, dimensionX / 2, dimensionY);
            }
            if (nodo.hijo3 != null) {
                g2d.drawLine(x, y, x + dimensionX / 2, y + dimensionY);
                dibujarArbol(g2d, nodo.hijo3, x + dimensionX / 2, y + dimensionY, dimensionX / 2, dimensionY);
            }
