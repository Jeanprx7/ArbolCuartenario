...
public class Arbol {
    ...
    public void anadirNodo(Nodo nodo, Nodo padre, boolean esIzq,boolean eshijo2,boolean eshijo3) {
        if (padre == null) {
            if (raiz == null) {
                raiz= nodo;
            } else {
    ...
    private String preordenImpresion(Nodo nodo) {
        if (nodo == null) return "";
        return nodo.etiqueta + " " + preordenImpresion(nodo.izquierda) + preordenImpresion(nodo.hijo2) + preordenImpresion(nodo.hijo3) + preordenImpresion(nodo.derecha);
    }
    ...
    private String inordenImpresion(Nodo nodo) {
        if (nodo == null) return "";
        return inordenImpresion(nodo.izquierda) + nodo.etiqueta + " " + inordenImpresion(nodo.hijo2) + inordenImpresion(nodo.hijo3) + inordenImpresion(nodo.derecha);
    }
    ...
    private String postordenImpresion(Nodo nodo) {
        if (nodo == null) return "";
        return postordenImpresion(nodo.izquierda) + postordenImpresion(nodo.hijo2) + postordenImpresion(nodo.hijo3) + postordenImpresion(nodo.derecha) + nodo.etiqueta + " ";
    }
